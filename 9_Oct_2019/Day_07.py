...
client = pymongo.MongoClient("mongodb+srv://Abhigupta06:<Abhi0006>@cluster0-ti73g.mongodb.net/test?retryWrites=true&w=majority")
mydb = client.forsk_db



def add_employee(idd, first, last, pay):
    unique_employee = mydb.Demo_1.find_one({"id":idd})
    if unique_employee:
        return "Employee already exists"
    else:
